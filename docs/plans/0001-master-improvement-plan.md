...
| 7 | A5 live run (n≈100–150, ×3, ablation) | Jay + either | ✅ n=100 single-repeat run landed (PR #53); grounded catch 70.7% vs 60.3% baseline, +10.3pp CI [+3.3,+18.6]. ×3 repeats + stronger model remain (token budget) |
